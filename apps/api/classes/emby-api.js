    ...
    try {
      ...
      while (startIndex < total || total === undefined) {
        const response = await axios.get(url, {
          ...
          params: {
            fields:
              "MediaSources,DateCreated,Genres,Overview,ProviderIds,ExternalUrls,CriticRating,OfficialRating,CommunityRating,Studios,Tags,People,PremiereDate,ProductionYear,SeriesId,SeasonId,IndexNumber,ParentIndexNumber",
