...
function Row(file) {
  ...
  async function downloadBackup(filename) {
    axios
      .get(`/backup/files/${encodeURIComponent(filename)}/ticket`, {
        headers: getHeaders(),
      })
      .then((response) => {
  ...
  async function restoreBackup(filename) {
    const url = `/backup/restore/${encodeURIComponent(filename)}`;
    setDisabled(true);
    axios
      .get(url, {
        headers: getHeaders(),
  ...
  async function deleteBackup(filename) {
    const url = `/backup/files/${encodeURIComponent(filename)}`;
    setDisabled(true);
    axios
      .delete(url, {
        headers: getHeaders(),
