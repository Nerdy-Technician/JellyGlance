...
docker compose up -d</code></pre>
            ...
            <template v-else-if="item.id === 'widgets'">
              ...
              <p>Download Homarr JSON widgets or the Homepage YAML pack from that Settings page, or from <a href="/operations/widgets">Homepage widgets</a>. After a Homarr import, paste the Glance key — it is not stored in the JSON. New keys can be widgets-only. Try the same routes in the app at <strong>Settings → API Key</strong>.</p>
            </template>
