...
const rows = [
  ...
  { name: "Homepage / Homarr API widgets", why: "Token-auth Homarr JSON, Homepage YAML, widgets-only keys, and Settings → API Key explorer.", values: { jellyglance: true, jellystat: false, jellydash: false } },
